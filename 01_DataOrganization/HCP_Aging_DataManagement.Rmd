...
```{r, echo = FALSE}
library(readxl)
behavdata <- read_xlsx("HCP_Aging/HCP_Aging_ndar_subject.xlsx")
FSQA <- read_xlsx("HCP_Aging/HCP_A_FS_QA.xlsx","Sheet2")
ThomQA <- read_xlsx("HCP_Aging/HCP_A_Thomas_QA.xlsx","Sheet1")
thalvol <- read_xlsx("HCP_Aging/HCP_Aging_ThalVols.xlsx")
FSetiv <- read_xlsx("HCP_Aging/HCP_A_FSeTIV.xlsx")
...
write.csv(GoodImaging,"HCP_Aging_CombinedData220131.csv")
